...
public class HardActivity extends AppCompatActivity {
    ...
    EditText guessInput;
    String answer = "pneumonoultramicroscopicsilicovolcanoconiosis";
    String eAnswer = "";
            ...
            public void onClick(View v) {
                ...
                if(checker)
                {
                    ...
                    if(count ==5) {
                        ...
                        startActivity(new Intent(HardActivity.this, Lose.class));
                ...
                {
                    startActivity(new Intent(HardActivity.this, Winn.class));
                }
            }//end on click
        });
    }
